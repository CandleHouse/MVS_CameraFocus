 ...
 *  @brief  采用超时机制获取一帧图片，SDK内部等待直到有数据时返回（与MV_CC_Display不能同时使用）
 *  @param  handle                      [IN]            设备句柄
 ...
 *  @return Success, return MV_OK. Failure, return error code
 **********************************************************************/
MVSDKEXPORT_API int __stdcall MV_CC_GetImageBuffer(IN void* handle, OUT MV_FRAME_OUT* pFrame, IN int nMsec);
...
/************************************************************************/
/************************************************************************
 *  @fn     MV_CC_GetIntValueEx
 *  @brief  获取Integer属性值
 *  @param  handle                      [IN]            设备句柄
 *  @param  strKey                      [IN]            属性键值，如获取宽度信息则为"Width"
 *  @param  pstValue                    [IN][OUT]       返回给调用者有关相机属性结构体指针
 *  @return 成功,返回MV_OK,失败,返回错误码
 ...
 *  @param  pstValue                    [IN][OUT]       Structure pointer of camera features
 *  @return Success, return MV_OK. Failure, return error code
 ************************************************************************/
MVSDKEXPORT_API int __stdcall MV_CC_GetIntValueEx(IN void* handle,IN const char* strKey,OUT MVCC_INTVALUE_EX *pIntValue);

/************************************************************************
 *  @fn     MV_CC_SetIntValueEx
 *  @brief  设置Integer型属性值
 *  @param  handle                      [IN]            设备句柄
 *  @param  strKey                      [IN]            属性键值，如获取宽度信息则为"Width"
 ...
 *  @return Success, return MV_OK. Failure, return error code
 ************************************************************************/
MVSDKEXPORT_API int __stdcall MV_CC_GetEnumValue(IN void* handle,IN const char* strKey,OUT MVCC_ENUMVALUE *pEnumValue);

/************************************************************************
 *  @fn     MV_CC_SetEnumValue
 *  @brief  设置Enum型属性值
 *  @param  handle                      [IN]            设备句柄
 *  @param  strKey                      [IN]            属性键值，如获取像素格式信息则为"PixelFormat"
 *  @param  nValue                      [IN]            想要设置的相机的属性值
 ...
 *  @return Success, return MV_OK. Failure, return error code
 ************************************************************************/
MVSDKEXPORT_API int __stdcall MV_CC_SetEnumValueByString(IN void* handle,IN const char* strKey,IN const char* sValue);

/************************************************************************
 *  @fn     MV_CC_GetFloatValue
 *  @brief  获取Float属性值
 *  @param  handle                      [IN]            设备句柄
 ...
 *  @return Success, return MV_OK. Failure, return error code
 ************************************************************************/
MVSDKEXPORT_API int __stdcall MV_CC_GetFloatValue(IN void* handle,IN const char* strKey,OUT MVCC_FLOATVALUE *pFloatValue);

/************************************************************************
 *  @fn     MV_CC_SetFloatValue
 *  @brief  设置float型属性值
 *  @param  handle                      [IN]            设备句柄
 *  @param  strKey                      [IN]            属性键值
 ...
 *  @return Success, return MV_OK. Failure, return error code
 ************************************************************************/
MVSDKEXPORT_API int __stdcall MV_CC_GetBoolValue(IN void* handle,IN const char* strKey,OUT bool *pBoolValue);

/************************************************************************
 *  @fn     MV_CC_SetBoolValue
 *  @brief  设置Boolean型属性值
 *  @param  handle                      [IN]            设备句柄
 *  @param  strKey                      [IN]            属性键值
 ...
 *  @return Success, return MV_OK. Failure, return error code 
************************************************************************/
MVSDKEXPORT_API int __stdcall MV_CC_RegisterEventCallBackEx(void* handle, const char* pEventName,
 ...
 *  @return Success, return MV_OK. Failure, return error code
 ************************************************************************/
MVSDKEXPORT_API int __stdcall MV_GIGE_GetGvcpTimeout(void* handle, unsigned int* pMillisec);

/************************************************************************
 *  @fn     MV_GIGE_SetRetryGvcpTimes
 *  @brief  设置重传GVCP命令次数
 *  @param  handle                      [IN]            设备句柄
...
/************************************************************************
 *  @fn     MV_GIGE_GetRetryGvcpTimes
 *  @brief  获取重传GVCP命令次数
 *  @param  handle                      [IN]            设备句柄
 *  @param  pRetryGvcpTimes             [IN]            重传次数指针
 *  @return 成功，返回MV_OK；错误，返回错误码 
 
 *  @fn     MV_GIGE_GetRetryGvcpTimes
 *  @brief  Get the number of retry GVCP cammand
 *  @param  handle                      [IN]            Device handle
 *  @param  pRetryGvcpTimes             [IN]            The number of retries
 *  @return Success, return MV_OK. Failure, return error code
 ************************************************************************/
MVSDKEXPORT_API int __stdcall MV_GIGE_GetRetryGvcpTimes(void* handle, unsigned int* pRetryGvcpTimes);

/************************************************************************
 *  @fn     MV_CC_GetOptimalPacketSize
...
/************************************************************************
 *  @fn     MV_GIGE_GetMulticastStatus
 *  @brief  获取组播状态
 *  @param  pstDevInfo                  [IN]            设备信息结构体
 *  @param  pStatus                     [OUT]           组播状态,true:组播状态，false:非组播
 *  @return 成功，返回MV_OK；错误，返回错误码 

 *  @fn     MV_GIGE_GetMulticastStatus
 *  @brief  Get Multicast Status
 *  @param  pstDevInfo                  [IN]            Device Information Structure
 *  @param  pStatus                     [OUT]           Status of Multicast
 *  @return Success, return MV_OK. Failure, return error code
 ************************************************************************/
MVSDKEXPORT_API int __stdcall MV_GIGE_GetMulticastStatus(IN MV_CC_DEVICE_INFO* pstDevInfo, OUT bool* pStatus);
...
/************************************************************************/
/************************************************************************
 *  @fn     MV_USB_SetTransferSize
 *  @brief  设置U3V的传输包大小
 *  @param  handle                      [IN]            设备句柄
 *  @param  nTransferSize               [IN]            传输的包大小, Byte，rang：2048-PayloadSize
 *  @return 成功,返回MV_OK,失败,返回错误码
 
 *  @fn     MV_USB_SetTransferSize
 *  @brief  Set transfer size of U3V device
 *  @param  handle                      [IN]            Device handle
 *  @param  nTransferSize               [IN]            Transfer size，Byte，rang：2048-PayloadSize.
 *  @return Success, return MV_OK. Failure, return error code 
************************************************************************/
MVSDKEXPORT_API int __stdcall MV_USB_SetTransferSize(IN void* handle, unsigned int nTransferSize);

/************************************************************************
 *  @fn     MV_USB_GetTransferSize
 *  @brief  获取U3V的传输包大小
 *  @param  handle                      [IN]            设备句柄
 *  @param  pTransferSize               [IN]            传输的包大小指针, Byte
 *  @return 成功,返回MV_OK,失败,返回错误码
 
 *  @fn     MV_USB_GetTransferSize
 *  @brief  Get transfer size of U3V device
 *  @param  handle                      [IN]            Device handle
 *  @param  pTransferSize               [IN]            Transfer size，Byte
 *  @return Success, return MV_OK. Failure, return error code 
************************************************************************/
MVSDKEXPORT_API int __stdcall MV_USB_GetTransferSize(IN void* handle, unsigned int* pTransferSize);

/************************************************************************
 *  @fn     MV_USB_SetTransferWays
 *  @brief  设置U3V的传输通道个数
 *  @param  handle                      [IN]            设备句柄
...
/************************************************************************
 *  @fn     MV_USB_GetTransferWays
 *  @brief  获取U3V的传输通道个数
 *  @param  handle                      [IN]            设备句柄
 *  @param  pTransferWays               [IN]            传输通道个数指针
 *  @return 成功,返回MV_OK,失败,返回错误码
 
 *  @fn     MV_USB_GetTransferWays
 *  @brief  Get transfer ways of U3V device
 *  @param  handle                      [IN]            Device handle
 *  @param  pTransferWays               [IN]            Transfer ways
 *  @return Success, return MV_OK. Failure, return error code 
************************************************************************/
MVSDKEXPORT_API int __stdcall MV_USB_GetTransferWays(IN void* handle, unsigned int* pTransferWays);
...
/************************************************************************/
/************************************************************************
 *  @fn     MV_CC_EnumInterfacesByGenTL
 *  @brief  通过GenTL枚举设备
 ...
 *  @return Success, return MV_OK. Failure, return error code 
 ************************************************************************/
MVSDKEXPORT_API int __stdcall MV_CC_EnumInterfacesByGenTL(IN OUT MV_GENTL_IF_INFO_LIST* pstIFList, IN const char * pGenTLPath);

/************************************************************************
 *  @fn     MV_CC_EnumDevicesByGenTL
 *  @brief  通过GenTL枚举设备
 *  @param  pstDevList                  [OUT]           设备列表
 *  @return 成功，返回MV_OK；错误，返回错误码 
 
 *  @fn     MV_CC_EnumDevicesByGenTL
 *  @brief  Enumerate Device with GenTL
 *  @param  pstDevList                  [OUT]           Device List
 *  @return Success, return MV_OK. Failure, return error code 
 ************************************************************************/
...
/************************************************************************
 *  @fn     MV_CC_CreateHandleByGenTL
 *  @brief  通过GenTL设备信息创建设备句柄
 *  @param  handle                      [OUT]           设备句柄
 *  @param  pDevInfo                  [IN]            设备信息结构体
 *  @return 成功，返回MV_OK；错误，返回错误码 
 
 *  @fn     MV_CC_CreateHandleByGenTL
 *  @brief  Create Device Handle with GenTL Device Info
 *  @param  handle                      [OUT]           Device handle
 *  @param  pDevInfo                  [IN]            Device Information Structure
 *  @return Success, return MV_OK. Failure, return error code
 ************************************************************************/
MVSDKEXPORT_API int __stdcall MV_CC_CreateHandleByGenTL(OUT void ** handle, IN const MV_GENTL_DEV_INFO* pDevInfo);
 ...
 *  @return Success, return MV_OK. Failure, return error code
 ***********************************************************************/
MVSDKEXPORT_API int __stdcall MV_XML_GetNodeAccessMode(IN void* handle, IN const char * pstrName, OUT MV_XML_AccessMode *pAccessMode);

/***********************************************************************
 *  @fn     MV_XML_GetNodeInterfaceType
 *  @brief  获得当前节点的类型
 *  @param  handle                      [IN]            设备句柄
 *  @param  pstrName                    [IN]            节点名称
 *  @param  pInterfaceType              [OUT]           节点的类型
 *  @return 成功，返回MV_OK；错误，返回错误码
 ...
 *  @param  handle                      [IN]            Device handle
 *  @param  pstrName                    [IN]            Name of node
 *  @param  pInterfaceType              [OUT]           Interface Type of the node
 *  @return Success, return MV_OK. Failure, return error code
 ***********************************************************************/
MVSDKEXPORT_API int __stdcall MV_XML_GetNodeInterfaceType(IN void* handle, IN const char * pstrName, OUT MV_XML_InterfaceType *pInterfaceType);
 ...
 *  @return Success, return MV_OK. Failure, return error code
 ************************************************************************/
MVSDKEXPORT_API int __stdcall MV_CC_SaveImageEx2(IN void* handle, MV_SAVE_IMAGE_PARAM_EX* pSaveParam);

/************************************************************************
 *  @fn     MV_CC_SaveImageToFile
 *  @brief  保存图像到文件，支持BMP/JPEG/PNG/TIFF
 *  @param  handle                      [IN]            设备句柄
 *  @param  pstSaveFileParam            [IN][OUT]       保存图片文件参数结构体
 *  @return 成功，返回MV_OK；错误，返回错误码 
 
 *  @fn     MV_CC_SaveImageToFile
 *  @brief  Save the image file, support Bmp、 Jpeg、Png and Tiff. Encoding quality(50-99]
 *  @param  handle                      [IN]            Device handle
